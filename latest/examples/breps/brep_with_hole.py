...
from compas_occt.brep import OCCBrepFace
...
edge = OCCBrepEdge.from_curve_and_surface(curve, surface)
...
viewer = Viewer()
viewer.renderer.camera.target = [1.5, 1.5, 0.6]
viewer.renderer.camera.position = [4.5, -1.5, 3.5]
